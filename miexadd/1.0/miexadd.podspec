...
Pod::Spec.new do |spec|
  ...
  spec.name         = "miexadd"
  spec.version      = "1.0"
  spec.summary      = "A short description of miexadd."
  ...
  spec.author             = { "zhaoke" => "zk@stxia.com" }
  # Or just: spec.author    = "zhaoke"
  # spec.authors            = { "zhaoke" => "zk@stxia.com" }
...
#   spec.resource  = "about.framework/about.bundle"
